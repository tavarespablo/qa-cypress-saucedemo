...
The architecture follows the **Page Object Model (POM)** and uses custom commands, elements layer, and fixtures to ensure an efficient and scalable test code.
...
- Automated Cypress execution via GitHub Actions
...
- Project designed to reflect real-world QA automation practices.
